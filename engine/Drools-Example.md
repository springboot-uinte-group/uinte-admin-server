...
- 使用kmodule的方式调用drools
    ...
    <kmodule xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
        ...
        <kbase name="HonestPoliticianKB" packages="com.uinte.drools.rule.honestpolitician">
...
- rule
    ```
    package com.uinte.drools                 //package指定命名空间:com.uinte.drools

    import com.uinte.drools.bean.Politician; //import要使用的对象:Politician
    import com.uinte.drools.bean.Hope;       //import要使用的对象:Hope
